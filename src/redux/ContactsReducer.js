...
const initialState = {
    contactsData: [
        ...
        { id: 2, name: 'Josefina', photoURL: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Firmin_Massot_-_Jos%C3%A9phine_de_France.jpg/411px-Firmin_Massot_-_Jos%C3%A9phine_de_France.jpg', messages: [{ type: 'answer', text: "Quickly come to the meeting room 1B, we have a big server issue", time: '4:00 AM', date: '4/22/17' }, { type: 'question', text: "I'm having breakfast right now, can't you wait for 10 minutes?", time: '4:05 AM', date: '4/22/17' }, { type: 'answer', text: "We are losing money! Quick!", time: '4:10 AM', date: '4/22/17' }] },
        { id: 3, name: 'Velazquez', photoURL: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Velazquez_figurando.jpg/411px-Velazquez_figurando.jpg', messages: [{ type: 'answer', text: "Quickly come to the meeting room 1B, we have a big server issue Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum", time: '4:00 AM', date: '3/18/17' }] },
        { id: 4, name: 'Barrera', photoURL: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Actriz_mexicana_Melissa_Barrera_en_2013.jpg/330px-Actriz_mexicana_Melissa_Barrera_en_2013.jpg', messages: [{ type: 'answer', text: "Quickly come to the meeting room 1B, we have a big server issue", time: '4:00 AM', date: '3/18/17' }] }
    ],
    activeContactId: '2',
    notification: null,
